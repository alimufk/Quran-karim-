...
public class AdhanReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (pm != null) {
            ...
            wakeLock.acquire(3 * 60 * 1000L); // إبقاء الجهاز مستيقظاً لمدة 3 دقائق
        }

        // 2. إظهار الإشعار وتشغيل الصوت مباشرة بدون سيرفس لمنع الكراش
    ...
    private void showNotificationAndPlaySound(Context context) {
        ...
        // تحديد مصدر الصوت (أذان محلي أو منبه النظام)
        Uri soundUri = null;
        ...
        // إنشاء قناة الإشعارات المباشرة بخصائص المنبه (تضمن الصوت حتى لو الشاشة مقفلة)
        ...
        // إعداد فتح التطبيق عند الضغط على الإشعار
        ...
        // إرسال الإشعار فوراً لشاشة أندرويد
        notificationManager.notify(1001, builder.build());

        // 3. رفع الصوت لأقصى درجة وتشغيله تلقائياً
        try {
