...
// 1️⃣ الرابط الأساسي لمجلد الصوتيات الخاص بك على جيت هاب
const BASE_AUDIO_URL = "https://raw.githubusercontent.com/alimufk/Quran-karim-/main/audio";

// 2️⃣ بيانات نصوص وقراءات الزيارات مع روابط الصوت المصححة بالعلامة المائلة `
export const ziyaratsData = {
  ...
  arbaeen: {
    ...
    arabicText: `اَلسَّلامُ عَلى وَلِيِّ اللهِ وَحَبيبِهِ، aَلسَّلامُ عَلى خَليلِ اللهِ وَنَجيبِهِ...`
  },
  saturday: {
    id: "saturday",
    ...
    arabicText: `أَشْهَدُ أَنْ لا إِلـهَ إِلاَّ اللهُ وَحْدَهُ لا شَرِيكَ لَهُ، وَأَشْهَدُ أَنَّكَ عَبْدُهُ وَرَسُولُهُ، وَأَنَّكَ مُحَمَّدُ بْنُ عَبْدِ اللهِ، وَأَشْهَدُ أَنَّكَ قَدْ بَلَّغْتَ رِسالاتِ رَبِّكَ، وَنَصَحْتَ لِأُمَّتِكَ، وَجاهَدْتَ فِي سَبِيلِ اللهِ بِالْحِكْمَة...`
  },
  sunday: {
    id: "sunday",
...
// 3️⃣ كود واجهة شاشة العرض (التي يبحث عنها ملف App.tsx ليعمل المشروع)
