...
const ZIYARAT_DATA: Record<string, { id: string; title: string; benefits: string; audioUrl: string; text: string }> = {
  ...
  "warith": {
    ...
    text: `السَّلامُ عَلَيْكَ يا وارِثَ آدَمَ صَفْوةِ اللهِ، السَّلامُ عَلَيْكَ يا وارِثَ نُوحٍ نَبِيِّ اللهِ، السَّلامُ عَلَيْكَ يا وارِثَ إِبْراهِيمَ خَلِيلِ اللهِ، السَّلامُ عَلَيْكَ يا وارِثَ مُوسَى كَلِيمِ اللهِ، السَّلامُ عَلَيْكَ يا وارِثَ عِيسَى رُوحِ اللهِ. السَّلامُ عَلَيْكَ يا وارِثَ مُحَمَّدٍ حَبِيبِ اللهِ، السَّلامُ عَلَيْكَ يا وارِثَ أَمِيرِ الْمُؤْمِنِينَ عَلَيْهِ السَّلامُ، السَّلامُ عَلَيْكَ يابْنَ مُحَمَّدٍ الْمُصْطَفى، السَّلامُ عَلَيْكَ يابْنَ عَلِيٍّ الْمُرْتَضى، السَّلامُ عَلَيْكَ يابْنَ فاطِمَةَ الزَّهْراءِ. أَشْهَدُ أَنَّكَ قَدْ أَقَمْتَ الصَّلاةَ، وَآتَيْتَ الزَّكاةَ، وَأَمَرْتَ بِالْمَعْرُوفِ، وَنَهَيْتَ عَنِ الْمُنْكَرِ، وَأَطَعْتَ اللهَ وَرَسُولَهُ حَتّى أَتاكَ الْيَقِينُ. فَلَعَنَ اللهُ أُمَّةً قَتَلَتْكَ، وَلَعَنَ اللهُ أُمَّةً ظَلَمَتْكَ، وَلَعَنَ اللهُ أُمَّةً سَمِعَتْ بِذلِكَ فَرَضِيَتْ بِهِ. يا مَوْلايَ يا أَبا عَبْدِ اللهِ، أَشْهَدُ أَنَّكَ كُنْتَ نُوراً فِي الأَصْلابِ الشَّامِخَةِ، وَالأَرْحامِ الطَّاهِرَةِ، لَمْ تُنَجِّسْكَ الْجاهِلِيَّةُ بِأَنْجاسِها، وَلَمْ تُلْبِسْكَ مِنْ مُدْلَهِمَّاتِ ثِيابِها، وَأَشْهَدُ أَنَّكَ مِنْ دَعائِمِ الدِّينِ، وَأَرْكانِ الْمُؤْمِنِينَ.`
  },
  "aminullah": {
    id: "aminullah",
...
export default function ZiyaratDetail() {
  ...
  // دالة ذكية تقسم النص لفقرات تتسع للشاشة تماماً بدلاً من كلمات معدودة
  const splitTextIntoPages = (fullText: string, maxCharsPerPage = 160) => {
    const sentences = fullText.split(/(?<=[.،؛\n])/);
    const resultPages: string[] = [];
    let currentChunk = "";

    for (const sentence of sentences) {
      if ((currentChunk + sentence).length > maxCharsPerPage) {
  ...
  useEffect(() => {
    if (currentItem) {
      const pageList = splitTextIntoPages(currentItem.text, 160);
      setPages(pageList);
      setCurrentPage(0);
