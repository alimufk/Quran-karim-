...
import { BookOpen, Calendar, ArrowRight, Download, CheckCircle2, Loader2, ShieldCheck, ChevronLeft, Eye, X } from 'lucide-react';
...
export const ziyaratsData: Record<string, { id: string; title: string; subtitle: string; benefits: string; audioUrl: string; arabicText: string }> = {
  ashura: {
    id: "ashura",
    title: "زيارة عاشوراء",
    ...
    arabicText: `السَّلامُ عَلَيْكَ يا أَبا عَبْدِ اللهِ، السَّلامُ عَلَيْكَ يابْنَ رَسُولِ اللهِ، السَّلامُ عَلَيْكَ يا خِيَرَةَ اللهِ وَابْنَ خِيَرَتِهِ، السَّلامُ عَلَيْكَ يابْنَ أَمِيرِ الْمُؤْمِنِينَ وَابْنَ سَيِّدِ الْوَصِيِّينَ، السَّلامُ عَلَيْكَ يابْنَ فاطِمَةَ سَيِّدَةِ نِساءِ الْعالَمِينَ، السَّلامُ عَلَيْكَ يا ثارَ اللهِ وَابْنَ ثارِهِ وَالْوِتْرَ الْمَوْتُورَ...`
  },
  warith: {
    id: "warith",
    title: "زيارة وارث",
    ...
    arabicText: `السَّلامُ عَلَيْكَ يا وارِثَ آدَمَ صَفْوةِ اللهِ، السَّلامُ عَلَيْكَ يا وارِثَ نُوحٍ نَبِيِّ اللهِ، السَّلامُ عَلَيْكَ يا وارِثَ إِبْراهِيمَ خَلِيلِ اللهِ، السَّلامُ عَلَيْكَ يا وارِثَ مُوسَى كَلِيمِ اللهِ، السَّلامُ عَلَيْكَ يا وارِثَ عِيسَى رُوحِ اللهِ...`
  },
  aminullah: {
    id: "aminullah",
    ...
    arabicText: `السَّلامُ عَلَيكَ يا أمِينَ اللهِ في أرضِهِ وَحُجَّتَهُ عَلى عِبادِهِ، السَّلامُ عَلَيكَ يا أمِيرَ المُؤْمِنِينَ، أشهَدُ أنَّكَ جاهَدتَ في اللهِ حَقَّ جِهادِهِ، وَعَمِلتَ بِكِتابِهِ، وَاتَّبَعتَ سُنَنَ نَبِيِّهِ صَلَّى اللهُ عَلَيهِ وَآلِهِ...`
  },
  jamia: {
    id: "jamia",
    ...
    arabicText: `السَّلامُ عَلَيْكُمْ يا أَهْلَ بَيْتِ النُّبُوَّةِ، وَمَوْضِعَ الرِّسالَةِ، وَمُخْتَلَفَ المَلائِكَةِ، وَمَبْطِطَ الوَحْيِ، وَمَعْدِنَ الرَّحْمَةِ، وَخُزَّانَ العِلْمِ، وَمُنْتَهَى الحِلْمِ...`
  },
  aleyasin: {
    id: "aleyasin",
    ...
    arabicText: `سَلامٌ عَلى آلِ يس، السَّلامُ عَلَيْكَ يا داعِيَ اللهِ وَرَبَّانِيَّ آياتِهِ، السَّلامُ عَلَيْكَ يا بابَ اللهِ وَدَيَّانَ دِينِهِ، السَّلامُ عَلَيْكَ يا خَلِيفَةَ اللهِ وَناصِرَ حَقِّهِ...`
  },
  nahiya: {
    id: "nahiya",
    ...
    arabicText: `السَّلامُ عَلى آدَمَ صَفْوةِ اللهِ مِن خَليقَتِهِ، السَّلامُ عَلى شِيثٍ وَلِيِّ اللهِ وَخِيَرَتِهِ، السَّلامُ عَلى إِدْريسَ القائِمِ بِحُجَّتِهِ...`
  },
  arbaeen: {
    id: "arbaeen",
    ...
    arabicText: `السَّلامُ عَلى وَلِيِّ اللهِ وَحَبيبِهِ، السَّلامُ عَلى خَليلِ اللهِ وَنَجيبِهِ، السَّلامُ عَلى صَفِيِّ اللهِ وَابْنِ صَفِيِّهِ...`
  },
  saturday: {
    id: "saturday",
    ...
    arabicText: `أَشْهَدُ أَنْ لا إِلَهَ إِلاَّ اللهُ وَحْدَهُ لا شَرِيكَ لَهُ، وَأَشْهَدُ أَنَّكَ رَسُولُهُ، وَأَنَّكَ مُحَمَّدُ بْنُ عَبْدِ اللهِ...`
  },
  sunday: {
    id: "sunday",
    ...
    arabicText: `السَّلامُ عَلَى الشَّجَرَةِ النَّبَوِيَّةِ، وَالدَّوْحَةِ الْهَاشِمِيَّةِ، الْمُضِيئَةِ الْمُثْمِرَةِ بِالنُّبُوَّةِ...`
  },
  monday: {
    id: "monday",
    ...
    arabicText: `السَّلامُ عَلَيْكَ يَا بْنَ رَسُولِ رَبِّ الْعالَمِينَ، السَّلامُ عَلَيْكَ يَا بْنَ أمِيرِ الْمُؤْمِنِينَ...`
  },
  tuesday: {
    id: "tuesday",
    ...
    arabicText: `السَّلامُ عَلَيْكُمْ يَا خُزَّانَ عِلْمِ اللهِ، السَّلامُ عَلَيْكُمْ يَا تَرَاجِمَةَ وَحْيِ اللهِ...`
  },
  wednesday: {
    id: "wednesday",
    ...
    arabicText: `السَّلامُ عَلَيْكُمْ يَا أَوْلِيَاءَ اللهِ، السَّلامُ عَلَيْكُمْ يَا حُجَجَ اللهِ...`
  },
  thursday: {
    id: "thursday",
    ...
    arabicText: `السَّلامُ عَلَيْكَ يَا وَلِيَّ اللهِ، السَّلامُ عَلَيْكَ يَا حُجَّةَ اللهِ وَخَالِصَتَهُ...`
  },
  friday: {
    id: "friday",
    ...
    arabicText: `السَّلامُ عَلَيْكَ يَا حُجَّةَ اللهِ فِي أَرْضِهِ، السَّلامُ عَلَيْكَ يَا عَيْنَ اللهِ فِي خَلْقِهِ...`
  }
};

// -------------------------------------------------------------
// 2. محرك IndexedDB للأوفلاين
// -------------------------------------------------------------
...
export default function Ziyarats() {
  ...
  // حالة التحكم بالنافذة المنبثقة لعرض النص
  const [selectedZiyarat, setSelectedZiyarat] = useState<any | null>(null);
  ...
  return (
    ...
    >
        ...
        {activeTab === 'general' ? (
          ...
          >
            {generalZiyarats.map((item) => {
              const details = ziyaratsData[item.id];
              ...
              return (
                <div 
                  key={item.id}
                  className="p-4 bg-[#064e3b]/40 rounded-2xl border border-[#059669]/30 hover:border-[#fbbf24]/50 transition flex justify-between items-center group"
                >
                  ...
                  <div className="flex items-center gap-2">
                    {/* زر فتح النص في النافذة المنبثقة */}
                    <button
                      onClick={() => setSelectedZiyarat(details)}
                      className="p-2.5 rounded-xl border bg-[#fbbf24] text-[#022c22] border-[#fbbf24] hover:bg-[#d97706] transition flex items-center gap-1 text-xs font-bold"
                    >
                      <Eye size={16} />
                      <span>قراءة</span>
                    </button>
          ...
          >
            {weeklyZiyarats.map((item) => {
              ...
              return (
                <div 
                  key={item.id}
                  className={`p-4 rounded-2xl border border-[#059669]/30 bg-gradient-to-r ${item.color} flex justify-between items-center shadow-md`}
                >
                  <div>
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      onClick={() => setSelectedZiyarat(details)}
                      className="p-2.5 rounded-xl bg-[#fbbf24] text-[#022c22] font-bold text-xs flex items-center gap-1 hover:bg-[#d97706] transition"
                    >
                      <Eye size={16} />
                      <span>قراءة</span>
                    </button>
                    ...
                    <button
                      ...
                      className={`p-2.5 rounded-xl border bg-[#022c22]/60 transition ${
                        isDownloaded ? 'text-[#059669] border-[#059669]/40' : 'text-[#fbbf24] border-[#059669]/30'
                      }`}
                    >
                      {isDownloading ? <Loader2 size={18} className="animate-spin" /> : isDownloaded ? <CheckCircle2 size={18} /> : <Download size={18} />}
                    </button>
      ...
      {/* ------------------------------------------------------------- */}
      {/* النافذة المنبثقة لعرض النص الشريف عند الضغط على "قراءة" */}
      {/* ------------------------------------------------------------- */}
      <AnimatePresence>
        {selectedZiyarat && (
          <motion.div 
          ...
          >
            <motion.div 
              ...
              animate={{ scale: 1, y: 0 }}
              exit={{ scale: 0.9, y: 20 }}
              className="bg-[#022c22] border border-[#059669]/50 rounded-3xl w-full max-w-2xl max-h-[85vh] flex flex-col shadow-2xl overflow-hidden"
            >
              {/* شريط أعلى النافذة */}
              <div className="p-4 bg-[#064e3b] border-b border-[#059669]/30 flex justify-between items-center">
                <h2 className="text-xl font-bold text-[#fbbf24]">{selectedZiyarat.title}</h2>
                <button 
                  onClick={() => setSelectedZiyarat(null)}
                  className="p-2 rounded-full bg-[#022c22] text-[#f0f9ff] hover:text-[#fbbf24] transition"
                >
                  <X size={20} />
                </button>
              </div>
              ...
              <div className="p-6 overflow-y-auto space-y-6 text-right">
                {selectedZiyarat.benefits && (
                  <div className="p-4 bg-[#064e3b]/40 border border-[#059669]/30 rounded-xl text-xs text-[#059669] leading-relaxed">
                    <strong className="text-[#fbbf24] block mb-1">فضائل هذه الزيارة:</strong>
                    {selectedZiyarat.benefits}
                  </div>
                )}

                <div className="p-6 bg-[#064e3b]/20 border border-[#059669]/20 rounded-2xl text-center leading-loose text-2xl font-serif text-[#f0f9ff] whitespace-pre-line">
                  {selectedZiyarat.arabicText}
                </div>
              </div>
            </motion.div>
          </motion.div>
