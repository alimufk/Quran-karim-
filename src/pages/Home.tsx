    ...
    <>
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-4 mt-6">
          ...
          {/* قسم إرشاد التائهين المطور */}
          <div onClick={() => navigate('/lost-and-found')} className="bg-[#064e3b]/40 border border-[#059669]/20 p-5 rounded-2xl cursor-pointer hover:border-[#059669]/60 transition-all flex flex-col items-center justify-center text-center gap-3">
            <div className="p-3 bg-[#fbbf24]/10 rounded-2xl text-[#fbbf24] flex items-center justify-center">
              <HelpCircle size={28} />
            </div>
