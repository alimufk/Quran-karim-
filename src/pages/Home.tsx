...
import { Settings, Bell, BookOpen, Clock, HeartPulse, Bookmark, ListTodo, Star, Sun, Moon, Image, Calendar, MapPin, Sparkles, ArrowUpCircle, X, CalendarDays, Scroll } from 'lucide-react'; 
      ...
      > 
        ...
        <header className="flex justify-between items-center mb-6 z-10"> 
          ...
          <div className="flex gap-3 items-center"> 
            ...
            > 
              <span className="text-xs text-[#fbbf24] font-medium">الإعدادات</span> 
        ...
        <div className="grid grid-cols-2 gap-4 mt-6"> 
          ...
          <button 
            ...
            className="col-span-2 bg-gradient-to-r from-[#d97706]/10 to-[#b45309]/20 border border-[#d97706]/40 p-5 rounded-[24px] flex items-center justify-between gap-3 hover:bg-[#d97706]/20 transition-all group relative overflow-hidden shadow-md text-right"
          > 
          ...
          <div onClick={() => navigate('/calendar-converter')} className="bg-[#064e3b]/40 border border-[#059669]/20 p-5 rounded-2xl cursor-pointer hover:border-[#059669]/60 transition-all flex flex-col items-center justify-center text-center gap-3"> 
            <div className="p-3 bg-[#fbbf24]/10 rounded-2xl text-[#fbbf24] flex items-center justify-center"> 
              <CalendarDays size={28} /> 
            </div> 
            <span className="font-medium text-sm text-[#f0f9ff]">محول التقويم</span> 
          </div> 

          {/* قسم الصحيفة السجادية (تم التعديل والأيقونة هنا) */} 
          <div onClick={() => navigate('/sahifa')} className="bg-[#064e3b]/40 border border-[#059669]/20 p-5 rounded-2xl cursor-pointer hover:border-[#059669]/60 transition-all flex flex-col items-center justify-center text-center gap-3"> 
            <div className="p-3 bg-[#fbbf24]/10 rounded-2xl text-[#fbbf24] flex items-center justify-center"> 
              <Scroll size={28} /> 
            </div> 
            <span className="font-medium text-sm text-[#f0f9ff]">الصحيفة السجادية</span> 
          </div> 
          ...
          <Link to="/mosques" className="col-span-2 bg-[#10b981]/10 border border-[#10b981]/30 p-5 rounded-[24px] flex items-center justify-between gap-3 hover:bg-[#10b981]/20 transition-all group relative overflow-hidden shadow-md"> 
            ...
            <div className="flex items-center gap-4 relative z-10"> 
              ...
              <div className="flex flex-col"> 
                ...
                <span className="text-xs text-[#34d399]">ابحث عن أقرب المساجد جغرافياً، والمسافات والاتجاهات الحقيقية</span> 
              </div> 
            </div> 
          ...
          <Link to="/radios" className="col-span-2 bg-[#064e3b]/40 border border-[#059669]/20 p-5 rounded-[24px] flex items-center justify-between gap-3 hover:bg-[#059669]/30 transition-all group"> 
            <div className="flex items-center gap-4"> 
              ...
              <div className="flex flex-col"> 
                ...
                <span className="text-xs text-[#059669]">بث مباشر لجميع القراء</span> 
              </div> 
            </div> 
          ...
          <Link to="/shia-duas" className="col-span-2 bg-[#064e3b]/40 border border-[#059669]/20 p-5 rounded-[24px] flex items-center justify-between gap-3 hover:bg-[#059669]/30 transition-all group"> 
            <div className="flex items-center gap-4"> 
              ...
              <div className="flex flex-col"> 
                ...
                <span className="text-xs text-[#059669]">كميل، الندبة، العهد، والمزيد</span> 
              </div> 
            </div> 
            <span className="text-[#fbbf24] font-bold">→</span> 
          </Link> 
          ...
          <Link to="/ziyarats" className="col-span-2 bg-[#064e3b]/40 border border-[#059669]/20 p-5 rounded-[24px] flex items-center justify-between gap-3 hover:bg-[#059669]/30 transition-all group"> 
            <div className="flex items-center gap-4"> 
              ...
              <div className="flex flex-col"> 
                ...
                <span className="text-xs text-[#059669]">الزيارات العامة وزيارات الأيام</span> 
              </div> 
            </div> 
            <span className="text-[#fbbf24] font-bold">→</span> 
          </Link> 
          ...
          <Link to="/wallpapers" className="col-span-2 bg-[#059669]/20 border border-[#059669]/40 p-5 rounded-[24px] flex items-center justify-between gap-3 hover:bg-[#059669]/30 transition-all group relative overflow-hidden"> 
            ...
            <div className="flex items-center gap-4 relative z-10"> 
              ...
              <div className="flex flex-col"> 
                ...
                <span className="text-xs text-[#fbbf24]">المراقد المقدسة، المناسبات الإسلامية والمخطوطات</span> 
              </div> 
            </div> 
        ...
        <div className="mt-6 p-6 bg-gradient-to-br from-[#064e3b]/60 to-[#042f2e]/80 border border-[#059669]/30 rounded-[32px] shadow-lg"> 
          ...
          <p className="font-arabic text-xl text-center text-[#f0f9ff] leading-relaxed italic px-2"> 
            "{dailyHadith.text}" 
          </p> 
