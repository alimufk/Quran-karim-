...
import { Settings, Bell, BookOpen, Clock, HeartPulse, Bookmark, ListTodo, Star, Sun, Moon, Image, Calendar, MapPin, Sparkles } from 'lucide-react';
    ...
    >
      ...
      <header className="flex justify-between items-center mb-6 z-10">
        ...
        <div className="flex gap-3 items-center">
          ...
          <div className="bg-[#064e3b] px-4 py-2 rounded-full border border-[#059669]/30 flex items-center gap-3">
        ...
        <Link to="/hotels" className="col-span-2 bg-[#0284c7]/10 border border-[#0284c7]/30 p-5 rounded-[24px] flex items-center justify-between gap-3 hover:bg-[#0284c7]/20 transition-all group relative overflow-hidden shadow-md">
          ...
          <div className="flex items-center gap-4 relative z-10">
             ...
             <div className="flex flex-col">
               ...
               <span className="text-xs text-[#38bdf8]">ابحث عن الفنادق القريبة من المراقد</span>
             </div>
          </div>
